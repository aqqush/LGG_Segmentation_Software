...
def gborders(img, mask, alpha=1.0, sigma=1.0):
    """Stopping criterion for image borders."""
    # The norm of the gradient.
    gradnorm = gaussian_gradient_magnitude(img, sigma, mode='constant')
    gradnorm = (gradnorm*mask.astype(int))
    return 1.0/np.sqrt(1.0 + alpha*gradnorm)

def gborders3D(img, mask, alpha=1.0, sigma=1.0):
    """Stopping criterion for image borders."""
    # The norm of the gradient.
    gradnorm = gaussian_gradient_magnitude(img, sigma, mode='constant')
    gradnorm = (gradnorm*mask.astype(int))
...
#        plt.imshow(dgI[0][:,:,15], cmap='gray')
#        plt.show()        
#        plt.imshow(dres[0][:,:,15], cmap='gray')
#        plt.show()    
#        plt.imshow(dgI[1][:,:,15], cmap='gray')
#        plt.show()        
#        plt.imshow(dres[1][:,:,15], cmap='gray')
#        plt.show() 
#        plt.imshow(dgI[2][:,:,15], cmap='gray')
#        plt.show()        
#        plt.imshow(dres[2][:,:,15], cmap='gray')
#        plt.show()    
# 
#        plt.imshow(aux[:,:,15], cmap='gray')
#        plt.show() 
